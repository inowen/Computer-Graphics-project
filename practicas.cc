...
// x,y es la posición en la que está en ese momento
...
//***************************************************************************
// Funcion llamada cada tick que no haya evento que procesar
//
// Propaga a la escena un tick de animación
//***************************************************************************

void funcion_idle() {
   if (escena!=nullptr) {
      escena->tickAnimacion();
   }
   glutPostRedisplay();
}
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: Noah Wenck");
   ...
   // asignación de la función llamada funcion_idle al evento de que no haya eventos (idle)
   ...
   std::cout << "\tV = Seleccionar modo de visualización " 
             << "(líneas, puntos, sólido, ajedrez, iluminación...)" << std::endl;
   std::cout << "\tD = Seleccionar modo dibujado (inmediato o diferido)" << std::endl;
   std::cout << "\tI = Menú de iluminación." << std::endl;
   std::cout << "\tM = Menú de animación manual." << std::endl;
   std::cout << "\tA = Menú de animación automática." << std::endl;
   std::cout << "\tC: Selección de la cámara." << std::endl;
